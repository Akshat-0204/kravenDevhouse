...
const systems = [
  {
    ...
    description:
      'Fast, accessible, pixel-precise interfaces built in React and TypeScript — for marketing sites, dashboards, and full products.',
    image: '/subServices/websites.avif',
  },
  {
    title: 'Custom Software',
    description:
      'Purpose-built applications and internal tools designed around how your team actually works, not a template.',
    image: '/subServices/CRM.avif',
  },
  {
    title: 'APIs & Integrations',
    description:
      'Clean backend services and integrations that connect your product to the tools and data your business depends on.',
...
const deliverySteps = [
  {
    ...
    title: 'Discover',
    description:
      'We learn the product, the users, and the constraints — technical and business — before a single line of code is written.',
  ...
  },
  {
    ...
    title: 'Design',
    description:
      'We design the interface and system architecture together, so what ships is both usable and buildable.',
  ...
  },
  {
    ...
    title: 'Build',
    description:
      'We develop in focused iterations, with working software to review at every step instead of a single big reveal.',
  ...
  },
  {
    ...
    description:
      'We connect the systems it needs to talk to and test rigorously across devices, edge cases, and real usage.',
  ...
  },
  {
    ...
    title: 'Launch & Refine',
    description:
      'Once live, we monitor performance and usage, then refine the product as real feedback comes in.',
...
export default function SoftwareSolutionsPage() {
  const [ctaMode, setCtaMode] = useState<'build' | 'ship'>('build')
  const [hoveredStep, setHoveredStep] = useState<number | null>(null)
  const ctaLabel = useMemo(
    () => (ctaMode === 'build' ? 'Build your product' : 'Ship something sharp'),
    [ctaMode],
  )
  ...
  useEffect(() => {
    const timer = window.setInterval(() => {
      setCtaMode((current) => (current === 'build' ? 'ship' : 'build'))
    }, 2200)
    ...
    <div className="bg-black text-white">
      ...
      <main className="pt-24 md:pt-28">
        <section className="relative mx-auto flex min-h-[78vh] max-w-6xl flex-col items-center justify-center overflow-hidden px-6 text-center md:px-10">
          ...
          >
            Not every problem is an automation problem. Sometimes you just need a product built well — clean frontend engineering, solid backend systems, and software that holds up under real use.
          </motion.p>
        </section>
        ...
        <SectionBlock className="px-6 py-24 md:px-10 md:py-32" delay={0.03}>
          <div className="mx-auto max-w-6xl">
            <div className="mb-10 text-center">
              ...
              >
                Software built like a product, not a project
              </motion.h2>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            >
              ...
              <p className="max-w-2xl self-end text-sm leading-relaxed text-white/55 md:text-base">
                Every build starts with understanding the problem. Hover through the process to see how we turn a product idea into shipped software.
              </p>
            </motion.div>
        ...
        <SectionBlock className="px-6 py-24 md:px-10 md:py-32" delay={0.07}>
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              Most software doesn't fail because of a missing feature. It fails because it was rushed, generic, or built by someone who didn't care about the details. We build like the product is ours — considered interfaces, solid engineering, and code a future team can actually work with.
            </motion.p>
          </div>
        </SectionBlock>
